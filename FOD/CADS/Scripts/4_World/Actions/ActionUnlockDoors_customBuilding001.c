...
class ActionUnlockDoors_customBuilding001: ActionContinuousBase
{
	void ActionUnlockDoors_customBuilding001()
	{
	...
	//	Print(target.GetObject().ToString());
		if(target.GetObject().ToString().Contains("dayz_house_test1"))
		{
			// do nothing
		}
		else
