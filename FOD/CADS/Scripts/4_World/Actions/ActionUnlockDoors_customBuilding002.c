...
class ActionUnlockDoors_customBuilding002: ActionContinuousBase
{


	void ActionUnlockDoors_customBuilding002()
	{
	...
	//	Print(target.GetObject().ToString());
		if(target.GetObject().ToString().Contains("dayz_house_test2"))
		{
			// do nothing
		}
		else
